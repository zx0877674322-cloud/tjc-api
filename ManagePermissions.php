...
<head>
    ...
    <style>
        :root {
            ...
            --bg-action-row: #fff7ed;
            --bg-action-cb: #ffffff;
            --border-action: #fed7aa;
            --text-action-primary: #c2410c;
            --text-action-code: #9a3412;
            --bg-action-code: #ffedd5;
        ...
        body.dark-mode {
            ...
            --bg-action-row: rgba(249, 115, 22, 0.15);
            --bg-action-cb: #0f172a;
            --border-action: #7c2d12;
            --text-action-primary: #fdba74;
            --text-action-code: #fed7aa;
            --bg-action-code: rgba(255, 237, 213, 0.1);
        }
        ...
        input:checked+.modern-cb {
            background: var(--primary-color);
            border-color: var(--primary-color);
            color: white;
        }

        input:disabled+.modern-cb {
            background: var(--hover-bg);
        ...
        .action-cb-style {
            border-color: var(--color-orange-main) !important;
            color: var(--color-orange-main);
            background: var(--bg-action-cb);
        }

        input:checked+.action-cb-style {
        ...
        .code-badge {
            font-size: 0.75rem;
            background: var(--bg-action-code);
            color: var(--text-action-code);
            padding: 2px 6px;
            border-radius: 4px;
            margin-left: 8px;
            ...
            <div class="container">
                <div class="card">
                    <div class="card-header">
                        <h2 style="margin:0; color:var(--text-main);"><i class="fas fa-shield-alt"></i>
                            กำหนดสิทธิ์การใช้งาน</h2>
                    </div>
                                ...
                                <tr>
                                    ...
                                    if ($roles && $roles->num_rows > 0) {
                                        ...
                                        while ($r = $roles->fetch_assoc()) {
                                            ...
                                            <th>
                                                <div class="role-head"
                                                    onclick="toggleRoleColumn('<?php echo $r['role_name']; ?>')">
                                    ...
                                    <tbody class="page-group" data-id="<?php echo $p['id']; ?>">
                                        <tr class="row-page">
                                                ...
                                                <div style="display:flex; align-items:center;">
                                                    ...
                                                    <div
                                                        ...
                                                        <div style="margin-left:10px;">
                                                            ...
                                                            <div
                                                                style="font-size:0.8rem; color:var(--text-muted); font-family:monospace;">
                                                                <?php echo $p['file_name']; ?></div>
                                                        </div>
                                                        <?php if ($has_actions): ?>
                                                            <button type="button" class="btn-toggle"
                                                                onclick="toggleSubRows(<?php echo $p['id']; ?>, this)">
                                            ...
                                            <?php foreach ($roles_arr as $r_name):
                                                ...
                                                if ($disabled)
                                                    echo "<input type='hidden' name='perms[$r_name][]' value='" . $p['id'] . "'>";
                                                ?>
                                                <td style="text-align:center;">
                                                    <label class="cb-wrap">
                                                        <input type="checkbox" name="perms[<?php echo $r_name; ?>][]"
                                                            value="<?php echo $p['id']; ?>" class="cb-role-<?php echo $r_name; ?>"
                                                            style="display:none;" <?php echo $checked; ?>             <?php echo $disabled; ?>>
                                            ...
                                            foreach ($actions_by_page[$p['id']] as $act): ?>
                                                <tr class="row-action group-<?php echo $p['id']; ?>">
                                                    <td class="col-sticky">
                                                        <div style="display:flex; align-items:center;">
                                                            <i class="fas fa-level-up-alt fa-rotate-90"
                                                                style="margin-right:10px; opacity:0.5; color:var(--text-muted);"></i>
                                                    ...
                                                    <?php foreach ($roles_arr as $r_name):
                                                        ...
                                                        <td style="text-align:center;">
                                                            <label class="cb-wrap">
                                                                <input type="checkbox" name="actions[<?php echo $r_name; ?>][]"
                                                                    value="<?php echo $act['action_code']; ?>"
                                                                    class="cb-role-<?php echo $r_name; ?>" style="display:none;" <?php echo $act_checked; ?>>
                                                                <div class="modern-cb action-cb-style"><i class="fas fa-fingerprint"></i>
                                                                </div>
                                                            </label>
                                                        </td>
                                                    <?php endforeach; ?>
