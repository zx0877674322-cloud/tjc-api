...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        h2 { color: #333; font-weight: 600; margin-bottom: 10px; font-size: 26px; }
        ...
        .input-icon-left {
            ...
            color: #ccc; font-size: 18px; pointer-events: none; transition: color 0.3s;
        }

        .input-field {
            width: 100%; padding: 14px 45px; 
            border: 1px solid #e1e1e1; background: #f9f9f9;
            border-radius: 10px; font-family: 'Prompt', sans-serif; font-size: 16px; outline: none; transition: all 0.3s;
        }
        ...
        .input-field:focus ~ .input-icon-left { color: var(--primary-color); }

        .toggle-password {
            position: absolute; right: 15px; top: 50%; transform: translateY(-50%);
            cursor: pointer; color: #ccc; font-size: 16px; transition: color 0.3s; z-index: 5;
        }
        ...
        .btn-login {
            ...
            color: white; font-size: 16px; font-weight: 600; font-family: 'Prompt', sans-serif;
            cursor: pointer; box-shadow: 0 5px 15px rgba(78, 84, 200, 0.3); transition: all 0.3s ease; margin-top: 10px;
        }
        .btn-login:hover { transform: translateY(-2px); box-shadow: 0 8px 20px rgba(78, 84, 200, 0.4); }

        .error-message {
            background: #fff5f5; color: var(--error-color); padding: 12px;
            border-radius: 8px; font-size: 14px; margin-bottom: 20px;
            border: 1px solid #ffcccc; display: flex; align-items: center;
        }
        ...
        .forgot-password-link {
            display: block;
            text-align: right;
            margin-top: -10px; /* ขยับขึ้นไปชิด input */
            margin-bottom: 20px;
            font-size: 14px;
            color: #666;
    ...
    <div class="login-card">
        ...
        <form method="POST" action="">
            <div class="input-group">
                <input type="text" name="username" class="input-field" placeholder="ชื่อผู้ใช้" required autocomplete="off" value="<?php echo isset($user_input) ? htmlspecialchars($user_input) : ''; ?>">
                <i class="fas fa-user input-icon-left"></i>
            </div>
            
            <div class="input-group">
                <input type="password" name="password" class="input-field" id="passwordField" placeholder="รหัสผ่าน" required>
